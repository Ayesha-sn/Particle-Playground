...
function App() {
  return (
    <div className="App min-h-screen relative grain" style={{ background: 'hsl(var(--background))' }}>
      ...
      {/* Header */}
      <header className="absolute top-0 left-0 right-0 z-20 px-4 py-4 md:px-6 md:py-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-4">
            <div className="px-3 md:px-4 py-1.5 md:py-2 rounded-lg border border-border/50 bg-card/50 backdrop-blur-sm">
